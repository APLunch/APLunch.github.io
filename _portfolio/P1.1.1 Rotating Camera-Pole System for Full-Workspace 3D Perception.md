---
title: "Rotating Camera-Pole System for Full-Workspace 3D Perception"
...
A compact motorized camera pole was co-designed with the hardware team and integrated into Pixmo’s sensor stack. The pole rotates a calibrated RGB-D camera around the robot, capturing dense 3D observations across the full 360° workspace.
...
2. **Levenberg–Marquardt non-linear optimization** over all frames (bundle-adjustment style) solving for:
   ...
   - Distortion of observed circular path  

This produced a high-accuracy model of the camera’s motion, enabling sub-centimeter global alignment of every frame.
...
I built a camera-pole simulation model for our internal Gazebo/Unity-based dev stack:
- Programmable virtual pole kinematics  
- Synthetic depth + RGB data generation  
- Drop-in replacement for real hardware streams  

This allowed rapid iteration of calibration algorithms, BT integration, and perception logic **without requiring the physical robot**, accelerating development and reducing hardware downtime.
